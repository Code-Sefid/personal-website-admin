<div>
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Articles /</span> Edit Article {{$title}}</h4>
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-body">
                        <form wire:submit="update">
                            ...
                            <div class="mt-4">
                                ...
                                <textarea wire:model="body"
                                          class="form-control"
                                          id="body" rows="5" wire:model="body">{{ $body }}</textarea>
                                </div>
                            ...
                            <div class="mt-4">
                                ...
                                @if($image)
                                    <img width="500" height="300" class="mt-4" src="{{ $image }}" wire:model="image">
                                @elseif($temporaryImageUrl = $image->temporaryUrl())
                                    <img width="500" height="300" class="mt-4" src="{{ $temporaryImageUrl }}" wire:model="image">
                                @endif
